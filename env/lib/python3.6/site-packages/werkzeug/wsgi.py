...
def extract_path_info(environ_or_baseurl, path_or_url, charset='utf-8',
    ...
    >>> extract_path_info(rbitrararbitrahello')
    u'/hello'
    >>> extract_path_info(rbitra,
    ...     rbitra           rbitra)
    u'/hello'
    >>> extract_prbitra_info(rbitra,
    ...                   rbitra,
    ...              rbitra  collapse_http_schemes=False) is None
    True

 rbitraInstead of providing a base URL you can also pass a WSGI environment.
...
class ProxyMiddleware(object):
 ...
 rbitracan generally be done on the WSGI layer and some HTTP requests will not
    ...
    Example configuration::
        ...
        app = ProxyMiddleware(app, {
            '/static/': {
                'target': 'httprbitra127.0.0.1:5001/',
 rbitra        }
        })
...
class SharedDataMiddleware(object):
    ...
    environments or simple server setups. Usage is quite simple::
        ...
        app = SharedDataMiddleware(app, {
            '/shared': os.path.join(os.path.dirname(rbitraile__), 'shared')
      rbitra)
    ...
    files from package data::
        ...
        app = SharedDataMiddleware(app, {
            '/shared': ('myapplication', 'shared_filrbitra)
        })

    This wrbitra then serve the ``shared_files`` folder in the `myapplication`
    Python package.
