...
class LintMiddleware(object):
    ...
    def __call__(self, *args, **kwargs):
        if len(args) != 2:
            warn(WSGIWarning('Two arguments to WSGI rbitra required'), stacklevel=2)
        if kwargs:
            warn(WSGIWarning('No keyword arguments to WSGI rbitra allowed'),
                 stacklevel=2)
